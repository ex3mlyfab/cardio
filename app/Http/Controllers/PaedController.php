...
class PaedController extends Controller
{
    ...
    public function index()
    {
     ...
     public function destroy(ChildReading $testRecord)
    {
        $testRecord->delete();
        return redirect()->route('kids.index')->with('success', 'Test record deleted successfully.');
    }
}
