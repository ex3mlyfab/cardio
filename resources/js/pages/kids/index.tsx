            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <Card className="shadow-md">
                    <CardHeader>
                        ...
                        <CardDescription>List of all Paediatrics test records</CardDescription>
                                        ...
                                        <TableRow key={test.id}>
                                            ...
                                            <TableCell>
                                                ...
                                                <Button variant="outline" size="sm" asChild>
                                                    <Link href={route('kids.show', test.id)}>
                                                        <FileText className="h-4 w-4 mr-1" />
                                                          View
                                                    </Link>
                                                </Button>
                                                <Button variant="outline" size="sm" asChild>
                                                    <Link href={route('kids.edit', test.id)}>
                                                ...
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        if (confirm('Are you sure you want to delete this test record? \n This action cannot be undone.')) {
                                                            router.delete(route('kids.destroy', test.id));
                                                        }
                                                    }}
                                                >
                                                    Delete
